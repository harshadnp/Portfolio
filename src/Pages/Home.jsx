...
// --- Memoized Components with updated "Deep Ocean Blue & Cyan" theme ---
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Typing Effect with updated cursor color */}
                <div
                ...
                >
                  ...
                  <span className="w-[3px] h-6 bg-gradient-to-t from-cyan-400 to-blue-500 ml-1 animate-blink"></span>
                </div>
            ...
            {/* Right Column - Lottie Animation with updated effects */}
            <div
            ...
            >
              <div className="relative w-full opacity-90">
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-cyan-600/10 to-blue-600/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${
                ...
                >
                  <div
                    className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
