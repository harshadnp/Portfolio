...
const IconButton = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
    ...
    <div className="relative p-2 sm:p-3 bg-slate-800/50 backdrop-blur-sm rounded-full border border-white/10">
        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span
                      data-aos="fade-right"
                      data-aos-delay="200"
                      className="inline-block px-2 bg-gradient-to-r from-white via-slate-200 to-slate-300 bg-clip-text text-transparent"
                    >
                      Welcome
                    </span>{" "}
                    <span
              ...
              >
                <a
                  href="https://www.harshadpatil.com/"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                      <TypewriterEffect text="Harshad Patil" />
                    </span>
                  </div>
                </a>
              </motion.div>
