...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const desiredOrder = ["HydroTrack (AgriTech Iot Solution)", "ByteLearn", "FakeShield"];
  ...
  return (
    // Updated background color to match the theme
    <div className="md:px-[10%] px-[5%] w-full sm:mt-10 mt-[3rem] bg-slate-900 overflow-hidden" id="Portofolio">
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Explore my journey through projects, certifications, and my experience.
      ...
      <Box sx={{ width: "100%" }}>
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              background: "linear-gradient(180deg, rgba(34, 211, 238, 0.03) 0%, rgba(59, 130, 246, 0.03) 100%)",
          ...
          <Tabs
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                "&.Mui-selected": {
                  color: "#fff",
                  // Updated selected background and shadow
                  background: "linear-gradient(135deg, rgba(34, 211, 238, 0.1), rgba(59, 130, 246, 0.1))",
                  boxShadow: "0 4px 15px -3px rgba(34, 211, 238, 0.1)",
                  "& .lucide": {
              ...
              "& .MuiTabs-indicator": {
                ...
                display: 'none', // Hiding default indicator for a cleaner look
              },
        ...
        >
          ...
          <TabPanel value={value} index={2} dir={theme.direction}>
            <div className="container mx-auto flex flex-col items-center gap-8 pb-[5%]">
